    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav" href="#">Marathon Home</a>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    ...
                    <h2 class="section-heading">Software Stopwatch:<br>Part of the services we offer!</h2>
                    <p class="lead">Some of the services we offer are : Easy access for race back end backboard. Enabling management of races and runners! </p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Signup and integration!<br>by PSDCovers</h2>
                    <p class="lead">Easy Signup and integrates easily with existing website.!</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-5 col-sm-6">
                    <hr class="section-heading-spacer">
                    <div class="clearfix"></div>
                    <h2 class="section-heading">Integration with a web API to be able to use your Smart devices</h2>
                    <p class="lead">A highly professional API to be able to use your smart phone and/or tablet!</p>
                </div>
                <div class="col-lg-5 col-lg-offset-2 col-sm-6">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-lg-offset-2 col-sm-5">
                    ...
                    <?php
                        ...
                        echo form_submit('submit','Add Member')."<br/>";
                        echo form_close();
                    ?>
                </div>
            </div>
